const buttons = [
    ...
    { text: "12 hrs", ms: 12 * 60 * 60 * 1000, styling: "basis-[22.75%]", stylingButton: "h-7" },
    { text: "18 hrs", ms: 18 * 60 * 60 * 1000, styling: "basis-[22.75%]", stylingButton: "h-7" },
    { text: "24 hrs", ms: 24 * 60 * 60 * 1000, styling: "basis-[22.75%]", stylingButton: "h-7" },
];
